...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
1）、v2ray(vless&trojan+tcp+tls+ws)+caddy2 （回落终极部署/套娃方式，或共用端口。）  
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
1）、v2ray(vless+tcp+tls+ws)+nginx （目前推荐部署，同时支持vless+tcp与ws类应用，回落给nginx。）  
...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
1）、v2ray(vless&trojan+tcp+tls+ws)+nginx （回落终极部署/套娃方式，或共用端口。）  
