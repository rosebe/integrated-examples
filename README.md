...
8）、v2ray(complete+trojan+h2)+naiveproxy （上一项应用融合v2ray全部应用+naiveproxy应用。）  
...
5）、v2ray(vless+tcp+tls+ws+trojan)+nginx （回落终极部署或nginx SNI分流优化。）  
6）、v2ray(complete+trojan+h2)+nginx+naiveproxy （上一项应用融合v2ray全部应用+naiveproxy应用。）  
注意：  
